...
const Confetti = forwardRef<
  ConfettiRef,
  React.ComponentPropsWithRef<"canvas"> & { options?: ConfettiOptions; globalOptions?: ConfettiGlobalOptions; manualstart?: boolean }
>((props, ref) => {
    ...
    >
      <defs>
        <linearGradient id="rev_grad1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" style={{ stopColor: "#aa80f3", stopOpacity: 0.85 }} />
          <stop offset="100%" style={{ stopColor: "#aa80f3", stopOpacity: 0.35 }} />
        </linearGradient>
        <linearGradient id="rev_grad2" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" style={{ stopColor: "#aa80f3", stopOpacity: 0.9 }} />
          <stop offset="50%" style={{ stopColor: "#c7b0ff", stopOpacity: 0.7 }} />
          <stop offset="100%" style={{ stopColor: "#aa80f3", stopOpacity: 0.5 }} />
        </linearGradient>
        <radialGradient id="rev_grad3" cx="50%" cy="50%" r="50%">
          <stop offset="0%" style={{ stopColor: "#aa80f3", stopOpacity: 0.8 }} />
          <stop offset="100%" style={{ stopColor: "#c7b0ff", stopOpacity: 0.3 }} />
        </radialGradient>
      ...
      <g style={{ animation: "float2 25s ease-in-out infinite" }}>
        ...
        <ellipse cx="50" cy="150" rx="180" ry="120" fill="#aa80f3" filter="url(#rev_blur2)" opacity="0.65" />
      </g>
    </svg>
  </>
);
